...
public class Exercicios03_estrutura_while {
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		
		/*01. Escreva um programa que repita a leitura de uma senha até que ela seja válida.
		...
		*/
		...
		/*2. Escreva um programa para ler as coordenadas (X,Y) de uma quantidade indeterminada de pontos
		...
		*/
		...
		/*3.Um Posto de combustíveis deseja determinar qual de seus produtos tem a preferência
